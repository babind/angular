angular.module('admin-categories',['resources.categories']);


angular.module('admin-categories').config(['$routeProvider',function($routeProvider) {
	$routeProvider
	.when('/categories',{
...
angular.module('admin-categories').controller('CategoriesListController',['$scope','$location','Categories',
...
angular.module('admin-categories').controller('CategoriesNewController',['$scope','$resource','$location','Categories',
